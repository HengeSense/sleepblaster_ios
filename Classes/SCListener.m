...
//	if (![(NSString *)route isEqualToString:@"Headset"] &&
//		![(NSString *)route isEqualToString:@"Headphone"] &&
//		![(NSString *)route isEqualToString:@"HeadphonesAndMicrophone"] &&
//		![(NSString *)route isEqualToString:@"HeadsetInOut"])
//	{
...
//			NSLog(@"it's set to the play and record category.");
//		} else {
//			NSLog(@"it's not set to the play and record category!");
//		}
