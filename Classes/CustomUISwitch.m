...
- (void)setupUserInterface
{
	...
	if (useLightGraphics) {
		bg.image = [UIImage imageNamed:@"switch_on_lighter.png"];
	} else {
	...
	if (useLightGraphics) {
		foreground.image = [UIImage imageNamed:@"switch_lighter.png"];
	} else {
...
{	
	...
	if (_on)
	{
		...
		if (useLightGraphics) {
			self.backgroundImage.image = [UIImage imageNamed:@"switch_on_lighter.png"];
		} else {
	...
	else
	{
		...
		if (useLightGraphics) {
			self.backgroundImage.image = [UIImage imageNamed:@"switch_off_lighter.png"];
		} else {
